...
public class AbstractQueryBuilderFactoryTest {
    private final TestFilter testFilter = new TestFilter();
    private final TestParser testParser = new TestParser();

    @Test
    public void addFilter() throws Exception {
        final AbstractQueryBuilderFactory factory = new SqlQueryBuilderFactory();
    ...
    public void addFilterAt() throws Exception {
        ...
        final int index = getIndexOfClass(factory.getFilters(), ValidateFilter.class);
    ...
    public void addParserAt() throws Exception {
        ...
        final int index = getIndexOfClass(factory.getRuleParsers(), EqualRuleParser.class);
     ...
     * @return
     */
    private int getIndexOfClass(final List list, final Class cls) {
