...
public class ValidateFilterTest {
    ...
    public void testEmptyRules() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-empty-rules.json");
        builder.build(json);
    }
    ...
    public void testEmptyField() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-empty-field.json");
        builder.build(json);
    }
    ...
    public void testEmptyType() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-empty-type.json");
        builder.build(json);
    }
    ...
    public void testEmptyOperator() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-empty-operator.json");
        builder.build(json);
    }
    ...
    public void testInValue() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-in-value.json");
        builder.build(json);
    }
    ...
    public void testBetweenValue() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-between-value.json");
        builder.build(json);
    }
    ...
    public void testEqualValue() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-equal-value.json");
        builder.build(json);
    }
}