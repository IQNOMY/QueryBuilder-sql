...
public class SqlInjectionAttackFilterTest {
    ...
    public void testErrorSqlTooLong() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-sql-too-long.json");
        builder.build(json);
    }
    ...
    public void testErrorSqlSpecialWord() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-sql-special-word.json");
        builder.build(json);
    }
    ...
    public void testErrorSqlKeyword() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-sql-key-word.json");
