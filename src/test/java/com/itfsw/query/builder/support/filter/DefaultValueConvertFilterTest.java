...
public class DefaultValueConvertFilterTest {
    ...
    public void testValue2String() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/value-2-string.json");
    ...
    public void testValue2Double() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/value-2-double.json");
        final SqlQueryResult result = builder.build(json);
    ...
    public void testValue2Integer() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/value-2-integer.json");
        final SqlQueryResult result = builder.build(json);
    ...
    public void testConvertError() throws IOException {
        final String json = FileHelper.getStringFrom("tasks/error-value-2-integer.json");
        builder.build(json);
    }
}